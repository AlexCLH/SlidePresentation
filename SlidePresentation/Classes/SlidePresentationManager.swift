...
public class SlidePresentationManager: NSObject {
...
extension SlidePresentationManager: UIViewControllerTransitioningDelegate {
    ...
    public func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return animator.init(style: style, isPresentation: true) as? UIViewControllerAnimatedTransitioning
    }
    
    public func animationController(forDismissed dismissed: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return animator.init(style: style, isPresentation: false) as? UIViewControllerAnimatedTransitioning
    }
}
